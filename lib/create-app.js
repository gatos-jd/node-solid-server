...
function createApp (argv = {}) {
  ...
  routeResolvedFile(app, '/common/js/', '@gatos-jd/solid-auth-client/dist-lib/solid-auth-client.bundle.js')
  routeResolvedFile(app, '/common/js/', '@gatos-jd/solid-auth-client/dist-lib/solid-auth-client.bundle.js.map')
